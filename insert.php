...
<form>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" id="exampleFormControlInput1" name="nim" placeholder="J3C118143">
    </div>

    <div class="form-group">
        <label for="exampleFormControlInput1">Nama</label>
        <input type="text" class="form-control" id="exampleFormControlInput1" name="nama" placeholder="Fiya">
    </div>
   ...
   <br>
    ...
    <div class="form-check">
         <label><input type="checkbox" name="olahraga[]" value="Menyanyi">Menyanyi</label><br>
         <label><input type="checkbox" name="olahraga[]" value="Berenang">Berenang</label><br>
         <label><input type="checkbox" name="olahraga[]" value="Membaca">Membaca</label><br>
         <label><input type="checkbox" name="olahraga[]" value="Fotografi">Fotografi</label><br>
    </div>
