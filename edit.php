  ...
  <body>
   ...
   <br>
    ...
    <div class="form-check">
         <label><input type="checkbox" name="olahraga[]" value="Menyanyi" 
         <?php if (in_array("Menyanyi", $dataor)) echo "checked";?>>Menyanyi</label><br>

         <label><input type="checkbox" name="olahraga[]" value="Berenang" 
         <?php if (in_array("Berenang", $dataor)) echo "checked";?> >Berenang</label><br>

         <label><input type="checkbox" name="olahraga[]" value="Membaca" 
         <?php if (in_array("Membaca", $dataor)) echo "checked";?>>Membaca</label><br>

         <label><input type="checkbox" name="olahraga[]" value="Fotografi" 
         <?php if (in_array("Fotografi", $dataor)) echo "checked";?>>Fotografi</label><br>
    </div>
